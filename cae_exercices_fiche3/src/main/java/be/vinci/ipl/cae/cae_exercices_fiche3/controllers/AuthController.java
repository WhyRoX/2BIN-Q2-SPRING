...
public class AuthController {
    ...
    public AuthenticatedUser login(@RequestBody Credentials credentials) {
        ...
        AuthenticatedUser authenticatedUser = userService.login(credentials.getUsername(), credentials.getPassword());
        if (authenticatedUser == null) throw new ResponseStatusException(HttpStatus.UNAUTHORIZED);
